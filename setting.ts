...
export class SettingTab extends PluginSettingTab {
	...
	display(): void {
		...
		new Setting(containerEl).setName(this.name).setHeading()
		new Setting(containerEl).setName(animationOptionTitle).setHeading()
		...
		new Setting(containerEl).setName(themeOptionTitle).setHeading()
